...
try:
    ...
    for i in range(data_macro2.shape[1]):
        ...
        for j in range(int((data_macro2.shape[0] + 1) / len_qpid_macro)):
            tmp.append((np.sum(data_macro2[j*len_qpid_macro:j*len_qpid_macro + len_qpid_macro, i])) / len_qpid_macro)
...
try:
    columns_to_be_removed2 = ['qp_id', 'material_id', 'time_id', 'temperature', 'strain_rate', 'force_field',
                              ...
                              'strain_22']
    # qp_id, material_id, time_id, temperature, strain_rate, force_field, replica_id, strain_00, strain_01, strain_02, strain_11, strain_12, strain_22, stress_00, stress_01, stress_02, stress_11, stress_12, stress_22
    #
